...
const getAllNotificationQuery = (query, userId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const unReadNotification = yield notification_model_1.default.countDocuments({
        userId,
        isRead: false,
    });
...
const getSingleReadNotification = (id, userId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield notification_model_1.default.findByIdAndUpdate(id, {
        $set: {
            isRead: true,
        },
    }, { new: true });
...
const getAllReadNotification = (userId) => __awaiter(void 0, void 0, void 0, function* () {
    // Fetch the user by ID
    const user = yield user_models_1.User.findById(userId);
    if (!user) {
        throw new AppError_1.default(404, 'User not found!');
    }
    const result = yield notification_model_1.default.updateMany({ userId: userId }, { $set: { isRead: true } });
    const unReadNotification = yield notification_model_1.default.countDocuments({
        userId,
        isRead: false,
    });
