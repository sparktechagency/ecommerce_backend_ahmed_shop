...
exports.userRoutes
    ...
    // )
    .get('/my-profile', (0, auth_1.default)(user_constants_1.USER_ROLE.CUSTOMER, user_constants_1.USER_ROLE.SELLER, user_constants_1.USER_ROLE.ADMIN, user_constants_1.USER_ROLE.SUB_ADMIN, user_constants_1.USER_ROLE.SUPER_ADMIN), user_controller_1.userController.getMyProfile)
    .get('/all-users', user_controller_1.userController.getAllUsers)
    .get('/dashboard-overview', user_controller_1.userController.getdashboardOverview)
    ...
    .patch('/update-my-profile', (0, auth_1.default)(user_constants_1.USER_ROLE.CUSTOMER, user_constants_1.USER_ROLE.SELLER, user_constants_1.USER_ROLE.ADMIN, user_constants_1.USER_ROLE.SUB_ADMIN, user_constants_1.USER_ROLE.SUPER_ADMIN), upload.single('image'), (0, parseData_1.default)(), user_controller_1.userController.updateMyProfile)
    .delete('/delete-my-account', (0, auth_1.default)(user_constants_1.USER_ROLE.CUSTOMER, user_constants_1.USER_ROLE.SELLER, user_constants_1.USER_ROLE.ADMIN, user_constants_1.USER_ROLE.SUB_ADMIN, user_constants_1.USER_ROLE.SUPER_ADMIN), user_controller_1.userController.deleteMyAccount)
